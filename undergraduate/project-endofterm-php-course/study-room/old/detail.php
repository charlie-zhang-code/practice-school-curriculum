...
<body>
  <div class="page-holder bg-light">
          ...
          <div class="col-lg-12">
            ...
            <ul class="list-unstyled small d-inline-block">
              ...
              <li class="py-2 mb-1">
                <?php echo
                  '
               <a class="btn btn-sm btn-dark mb-2" href="order.php?id=' . $row["id"] . '">
                        预约
                </a>
                ';
                ?>
    ...
    <script>
      ...
      } // this is set to BootstrapTemple website as you cannot // inject local
              SVG sprite(using only 'icons/orion-svg-sprite.svg' path) // while using file:// protocol // pls don't
              forget to change to your domain:) injectSvgSprite('icons / orion - svg - sprite.svg'); </script>
