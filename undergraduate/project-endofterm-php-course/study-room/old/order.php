                                    ...
                                    <tr>
                                        <th class="ps-0 py-3 border-light" scope="row">
                                            <div class="d-flex align-items-center">
                                                <a class="reset-anchor d-block animsition-link" href="detail.php?id=<?php echo $row['id'];?>">
                                                    <img src="<?php echo $row['image_url']; ?>" alt="..." width="70" />
                                                </a>
                                                <div class="ms-3">
                                                    <strong class="h6">
                                                        <a class="reset-anchor animsition-link" href="detail.php?id=<?php echo $row['id'];?>">
                                                        <?php echo $row['name']; ?>
                                                        </a>
                                                    </strong>
                                                </div>
                                        ...
                                        <td class="p-3 align-middle border-light">
                                            <!-- 点击确认进入order_handle -->
                                            <a class="btn btn-sm btn-dark" href="handle/order_handle.php?id=<?php echo $row['id'];?>">
                                                确认
                                            </a>
                                            <!-- 点击取消返回首页 -->
                                            <a class="btn btn-sm btn" href="index.php">
                                                取消
                                            </a>
                                        </td>
                                    </tr>
