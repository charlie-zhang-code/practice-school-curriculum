  ...
  <div>
    <div class="container">
      <div class="login-form" style="backgroundColor:rgba(255, 215, 0, 0.02);borderRadius:20px">
        <h1 class="h1" style="color:rgba(255, 69, 0, 1);fontSize:30px;">网上购物商城系统研发注册</h1>
		<el-form ref="rgsForm" class="rgs-form" :model="rgsForm" label-width="120px">
			...
			<el-form-item label="账号" class="input" v-if="tableName=='shangjia'">
			...
			<el-form-item label="身份证" class="input" v-if="tableName=='yonghu'">
			  <el-input v-model="ruleForm.shenfenzheng" autocomplete="off" placeholder="身份证" type="text" />
				...
				<button class="btn close" type="primary" @click="close()">取消</button>
			</div>
		</el-form>
      </div>
  ...
  methods: {
    ...
    login() {
        ...
        return
                                                                                                                        ...
                                                                                                                        if((!this.ruleForm.shouji) && `shangjia` == this.tableName){
        ...
        return
                                    ...
                                    if((!this.ruleForm.shenfenzheng) && `shangjia` == this.tableName){
