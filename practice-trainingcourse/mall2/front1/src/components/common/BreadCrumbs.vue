<template>
  <!-- <el-breadcrumb class="app-breadcrumb" separator="/" style="height:50px;backgroundColor:rgba(255, 255, 255, 1);borderRadius:20px;padding:0px 20px 0px 20px;boxShadow:0px 0px 0px #f903d4;borderWidth:0px;borderStyle:0px;borderColor:rgba(248, 247, 247, 1);">
    ...
    breadcrumbStyleChange(val) {
      this.$nextTick(()=>{
        ...
        document.querySelectorAll('.app-breadcrumb .el-breadcrumb__inner .no-redirect').forEach(el=>{
          el.style.color = "rgba(41, 42, 44, 1)"
        })
