<template>
  <el-aside class="index-aside" height="100vh" width="210px">
    <div class="index-aside-inner menulist" style="height:100%;color: white;">
      <div v-for="item in menuList" :key="item.roleName" v-if="role==item.roleName" class="menulist-item" style="color: white;height:100%;broder:0;">
        ...
        <el-menu mode="horizontal" :unique-opened="false" class="el-menu-demo" style="height:100%; color: white;" text-color="#080808" active-text-color="#000000" default-active="0">
      ...
      this.$nextTick(()=>{
        document.querySelectorAll('.menulist .el-menu-item').forEach(el=>{
          ...
          el.addEventListener("mouseleave", e => {
            e.stopPropagation()
            // el.style.backgroundColor = "#e23e57"
          })
